...
/**
 * 作者：yokin.li on 2017/10/9 11:15
 * 邮箱：86558543@qq.com
 * 仿商城二级联动
 */

public class ErJiDemo extends AppCompatActivity implements CheckListener {
    private String TAG=ErJiDemo.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ac_erji);
        mContext = this;
    }
